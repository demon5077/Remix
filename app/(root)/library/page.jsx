  ...
  return (
    <div className="px-5 md:px-8 lg:px-10 py-8 space-y-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        {[
          { href: "/liked",  label: "Liked Songs",      color: "var(--accent)", sub: `${likedIds.length} songs` },
          ...
          >
            <p className="font-bold text-sm" style={{ color: "var(--text-primary)", fontFamily: "Rajdhani, sans-serif" }}>{label}</p>
      ...
      {recentlyPlayed.length > 0 && (
        <section>
          <h2 className="text-base font-bold mb-5" style={{ color: "var(--text-primary)", fontFamily: "Rajdhani, sans-serif" }}>
            Recently Played
          </h2>
          <ScrollArea>
