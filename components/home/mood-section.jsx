...
const MOODS = [
  ...
  },
  {
    id: "night-drive",
    title: "Night Drive",
    desc: "Synthwave · Retrowave · Lo-Fi",
    gradient: "linear-gradient(135deg, #0d001f, #4B0082)",
  ...
  },
  {
    id: "shadow-hours",
    title: "Shadow Hours",
    desc: "Jazz · Soul · Neo-Soul",
    gradient: "linear-gradient(135deg, #001122, #003366)",
    glow: "rgba(0,100,255,0.25)",
    icon: "🌊",
  },
  {
    id: "abyss",
    title: "Into the Abyss",
    desc: "Ambient · Post-Rock · Cinematic",
    gradient: "linear-gradient(135deg, #050508, #1a1a2e)",
  ...
  },
  {
    id: "bloodlust",
    title: "Bloodlust",
    desc: "Metal · Hardcore · Death Rock",
    gradient: "linear-gradient(135deg, #3B0000, #660000)",
  ...
  },
  {
    id: "void",
    title: "The Void",
    desc: "Drone · Dark Ambient · Experimental",
    gradient: "linear-gradient(135deg, #030305, #111120)",
    glow: "rgba(80,0,180,0.2)",
    icon: "∅",
  },
];
      ...
      <div className="flex items-end justify-between">
        <div>
          ...
          <p className="text-xs mt-0.5" style={{ color: "#44445a" }}>
            Curated for your state of mind
          </p>
        </div>
      </div>

      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
        {MOODS.map(({ id, title, desc, gradient, glow, icon }) => (
          <button
            key={id}
